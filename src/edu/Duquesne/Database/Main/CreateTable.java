...
public class CreateTable extends TableContainer{
	...
	public void getTableFile(String fileName){
		...
		gatherColumnMeta(createTable(fileName), );
	}

	private ArrayList<String> createTable(String fileName){
	...
	private ArrayList<String> gatherColumnMeta(ArrayList<String> tableLine, String columnData){
